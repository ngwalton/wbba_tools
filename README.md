...
To load your own data, put your EBD file in the folder: data/chrontplot_data, and delete the example file here. There can only be one csv in this folder. The script will chop it up into separate files by species.
