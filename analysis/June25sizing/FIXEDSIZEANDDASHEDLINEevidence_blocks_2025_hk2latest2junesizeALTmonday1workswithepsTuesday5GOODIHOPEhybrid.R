...
# more fixes for WI
sp_in$SPEC[sp_in$COMMON.NAME == "Golden-winged x Blue-winged Warbler (hybrid)"] <- "GWBW " #Must have changed since 2018
sp_in$SPEC[sp_in$COMMON.NAME == "Mallard x American Black Duck (hybrid)"] <- "MABD" #Must have changed since 2018
sp_in$SPEC[sp_in$COMMON.NAME == "Sandhill x Whooping Crane (hybrid)"] <- "SCWC" #Must have changed since 2018
