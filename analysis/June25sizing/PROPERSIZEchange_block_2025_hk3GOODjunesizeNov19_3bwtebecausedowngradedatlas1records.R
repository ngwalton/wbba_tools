...
sp <- list(i = read.delim("ebd_US-WI_buwtea_199501_200012_relOct-2025.txt", quote = ""),
           ii = read.delim("ebd_US-WI_buwtea_201501_201912_relOct-2025.txt", quote = "")) %>%
  ## only keep the pertinent columns
  map(dplyr::select,
      CATEGORY, COMMON.NAME, BREEDING.CODE, BREEDING.CATEGORY, 
      BLOCK.ID = ATLAS.BLOCK, APPROVED)
