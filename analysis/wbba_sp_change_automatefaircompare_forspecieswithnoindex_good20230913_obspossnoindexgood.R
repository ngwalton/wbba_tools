...
# THIS VERSION PRINTS OBSPOSS BUT NO INDEX
# 
...
#because obsposs species, only keep level C3 and C4 codes
sp <- lapply(sp, function (z) dplyr::filter(z, BREEDING.CODE %in% 
    c("S7", "M", "T", "P", "C", "B", "CN", "NB", "A", "N",
...
# this run is on species with less than ten blocks where we will not calculate 
# index
